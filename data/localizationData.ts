// This file contains master lists of languages and currencies for the localization feature.

export const allLanguages: { code: string, name: string }[] = [
...
export const allCurrencies: { code: string, name: string }[] = [
