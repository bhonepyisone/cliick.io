...
router.post('/link', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/unlink', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/facebook/callback', async (req: Request, res: Response) => {
  try {
    ...
    if (error) return res.status(400).json({ success: false, error: 'OAuth error' });
...
router.get('/viber/callback', async (req: Request, res: Response) => {
  try {
