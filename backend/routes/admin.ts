 ...
 * Body: { userId: string }
 */
router.post('/grant-super-admin', authenticateToken, async (req: Request, res: Response) => {
    try {
 ...
 * Body: { userId: string }
 */
router.post('/revoke-super-admin', authenticateToken, async (req: Request, res: Response) => {
    try {
        const { userId } = req.body;
 ...
 */
router.get('/list-super-admins', authenticateToken, async (req: Request, res: Response) => {
    try {
        // Check if requester is a super admin
        const { data: requesterProfile } = await supabase
            .from('profiles')
