...
exports.savePlatformSettings = exports.getPlatformSettings = void 0;
const supabasePlatformService_1 = require("./supabasePlatformService");
...
const getPlatformSettings = async () => {
    ...
    try {
        const settings = await (0, supabasePlatformService_1.getPlatformSettings)();
        if (settings) {
    ...
    const defaultSettings = (0, supabasePlatformService_1.getDefaultPlatformSettings)();
...
const savePlatformSettings = async (settings) => {
    ...
    // Save to Supabase
    try {
        await (0, supabasePlatformService_1.savePlatformSettings)(settingsToSave);
