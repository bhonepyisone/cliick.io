import { PlatformSettings, AIToneConfig, SubscriptionPlanDetails, DataHistoryTier, DataHistoryTierConfig, AIDescriptionGeneratorConfig, AIPhotoStudioConfig, AIConversationalCommerceConfig, AIModelAssignments, AIGlobalConfig, PlanEntitlements, PlanFeatures, PaymentMethod, GrowthPlanTierConfig } from '../types';
import { getPlatformSettings as getSupabasePlatformSettings, savePlatformSettings as saveSupabasePlatformSettings, getDefaultPlatformSettings as getSupabaseDefaultSettings } from './supabasePlatformService';
...
window.addEventListener('storage', (event) => {
    if (event.key === PLATFORM_SETTINGS_KEY) {
        settingsCache = null; // Invalidate cache on change from other tabs
    }
});
// --- End Caching Layer ---


// Mockup QR code Data URL
const MOCK_QR_CODE = 'data:image/png;base64,-ense.io/';

const defaultToneConfigs: AIToneConfig[] = [
    {
        id: 'male',
        tone: 'male',
        rules: {
...
const defaultSubscriptionPlans: SubscriptionPlanDetails[] = [
    {
        id: 'plan_starter',
        name: 'Starter',
        price: 25000,
...
const defaultDataHistoryTierConfig: DataHistoryTierConfig = {
...
const defaultGrowthPlanTierConfig: GrowthPlanTierConfig = {
...
const defaultDescriptionGeneratorConfig: AIDescriptionGeneratorConfig = {
...
const defaultPhotoStudioConfig: AIPhotoStudioConfig = {
    presets: [
...
const defaultConversationalCommerceConfig: AIConversationalCommerceConfig = {
    proPlanInstructions: `
...
const defaultModelAssignments: AIModelAssignments = {
...
const defaultGlobalModelConfig: AIGlobalConfig = {
    temperature: 0.9,
    topP: 1,
    topK: 1,
};

const defaultPlanEntitlements: PlanEntitlements = {
    'Starter': {
    ...
    'Growth': {
        conversationalCommerce: { enabled: true, limit: 0 }, // Placeholder, tier will override
    ...
    'Pro': {
        ...
        aiDescriptionGeneration: { enabled: true, limit: null }, // unlimited
        shopDashboardSuggestion: { enabled: true, limit: 50 },
        basicDashboards: { enabled: true },
        advancedDashboards: { enabled: true },
        customUrlSlug: { enabled: true },
        itemCount: { enabled: true, limit: null }, // unlimited
        keywordRuleCount: { enabled: true, limit: null }, // unlimited
        trainingSectionCount: { enabled: true, limit: 30 },
...
// Function to generate data history tiers dynamically
const generateDataHistoryTiers = (config: DataHistoryTierConfig): DataHistoryTier[] => {
    const tiers: DataHistoryTier[] = [];
...
const generateGrowthPlanTiers = (
    config: GrowthPlanTierConfig, 
    baseGrowthEntitlements: Partial<PlanFeatures>
): { plans: SubscriptionPlanDetails[], entitlements: { [key: string]: Partial<PlanFeatures> } } => {
    const plans: SubscriptionPlanDetails[] = [];
    const entitlements: { [key: string]: Partial<PlanFeatures> } = {};
    ...
    for (let i = 0; i < config.tierCount; i++) {
        ...
        const planDetails: SubscriptionPlanDetails = {
            id: planId,
            name: 'Growth', // The card name
            price: price,
            features: [], // Features are based on the template, not stored here
            isProTier: false,
            family: 'Growth',
            tierName: tierName,
...
const getDefaultPlatformSettings = (): PlatformSettings => {
    ...
    const baseGrowthEntitlements: Partial<PlanFeatures> = defaultPlanEntitlements['Growth'] || {};
    ...
    return {
        ...
        dataHistoryTiers: dataHistoryTiers,
...
export const getPlatformSettings = async (): Promise<PlatformSettings> => {
    ...
    try {
        const settings = await getSupabasePlatformSettings();
        if (settings) {
    ...
    const defaultSettings = getSupabaseDefaultSettings();
    settingsCache = defaultSettings;
    return defaultSettings;
};

export const savePlatformSettings = async (settings: PlatformSettings) => {
    // Before saving, regenerate the data history tiers from the config
    const settingsToSave = {
        ...settings,
        dataHistoryTiers: generateDataHistoryTiers(settings.dataHistoryTierConfig)
    };
    
    // Also regenerate growth plan tiers
    const baseGrowthEntitlements = settings.planEntitlements['Growth'] || defaultPlanEntitlements['Growth'] || {};
    ...
    settingsToSave.subscriptionPlans = [...settingsToSave.subscriptionPlans.filter(p => p.family !== 'Growth' || p.isTemplate), ...growthPlans];
    
    // Clean up old growth plan entitlements before adding new ones
    ...
    // Save to Supabase
    try {
        await saveSupabasePlatformSettings(settingsToSave);
        settingsCache = settingsToSave;
    } catch (error) {
        console.error('Failed to save platform settings to Supabase:', error);
        // Don't fallback to localStorage for saves - ensure data goes to database
        throw error;
    }
};